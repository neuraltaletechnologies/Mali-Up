...
class AppTheme {
  ...
  // deliberately leaves systemOverlayStyle unset so Flutter derives icon
  // brightness from each app bar's backgroundColor (white top → dark icons,
  // navy top → light icons).

  /// Dark status bar icons — for screens with a white/light top background.
  static const SystemUiOverlayStyle statusBarDarkIcons = SystemUiOverlayStyle(
    statusBarColor: Colors.transparent,
    statusBarIconBrightness: Brightness.dark,
    statusBarBrightness: Brightness.light,
  );

  /// Light (white) status bar icons — for screens with a navy/dark top background.
  static const SystemUiOverlayStyle statusBarLightIcons = SystemUiOverlayStyle(
    statusBarColor: Colors.transparent,
  ...
  static ThemeData get lightTheme {
    ...
    return ThemeData(
      ...
      appBarTheme: AppBarTheme(
        ...
        // systemOverlayStyle intentionally omitted: each AppBar derives status
        // bar icon brightness from its own backgroundColor.
