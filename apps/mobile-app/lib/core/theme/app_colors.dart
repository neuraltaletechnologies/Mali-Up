...
/// Mali Up — Premium Fintech Design System
/// Primary Navy: #0D1B3E | Secondary Navy: #1C3A7A | Teal: #1A6E8A | Yellow: #FFC107
class AppColors {
  // ── Core Brand Tokens ──────────────────────────────────────────────────────

  static const Color navyPrimary   = Color(0xFF0D1B3E); // Deep midnight navy
  static const Color navySecondary = Color(0xFF1C3A7A); // Medium navy
