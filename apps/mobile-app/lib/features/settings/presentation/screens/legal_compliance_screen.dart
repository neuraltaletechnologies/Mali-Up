...
class LegalComplianceScreen extends StatelessWidget {
  ...
  String _privacySummary() => _tr(
        ...
        'expense records, inventory data, and uploaded receipts and logos.\n\n'
        ...
        'security services. Mali Up does not use a third-party crash-reporting or analytics service, '
        'and has no third-party AI integration.\n\n'
        ...
        'rekodi za gharama, data ya bidhaa, na risiti au nembo zilizopakiwa.\n\n'
        ...
        'Mali Up haitumii huduma ya nje ya kuripoti hitilafu wala uchambuzi, '
        'na haina muunganisho wa AI wa mtu mwingine.\n\n'
