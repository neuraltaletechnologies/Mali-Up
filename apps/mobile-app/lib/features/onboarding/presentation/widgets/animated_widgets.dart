          ...
          child: Opacity(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: const Color(0xFF0B5ED7).withOpacity(0.3),
                  width: 1.5,
                ),
              ),
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      _buildAnimatedBar(0.4),
                      _buildAnimatedBar(0.6),
                      _buildAnimatedBar(0.5),
                      _buildAnimatedBar(0.8),
                      _buildAnimatedBar(0.7),
                    ],
                  ),
                ],
              ),
  ...
  Widget _buildAnimatedBar(double height) {
    return Expanded(
      child: Container(
        ...
        height: height * 80 * _animation.value,
        decoration: BoxDecoration(
          gradient: const LinearGradient(
...
/// Animated floating icon widget for cards
...
class _AnimatedFloatingIconState extends State<AnimatedFloatingIcon>
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        final offsetY =
            10 * (2 * (0.5 - (_floatAnimation.value - 0.5).abs()) - 1);
        return Transform.translate(
...
/// Pulsing glow effect for splash screen
...
/// Scale and fade entrance animation for onboarding cards
