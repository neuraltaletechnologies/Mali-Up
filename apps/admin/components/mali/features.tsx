...
const modules = [
  { icon: ShoppingCart, color: "#F5A623", title: "Sales & POS",          desc: "Process sales instantly, manage products, apply discounts, and generate receipts — even offline on 3G." },
  { icon: FileText,     color: "#22C55E", title: "Smart Invoicing",      desc: "Create professional invoices in TSh, track payment status, and send automated reminders to clients." },
  ...
  { icon: TrendingUp,   color: "#F5A623", title: "Finance & Accounting", desc: "Track income, expenses, cash flow, and profit margins with visual charts tailored for Tanzanian SMBs." },
  ...
  { icon: Building2,    color: "#F5A623", title: "Multi-Business",       desc: "One platform for multiple businesses. Each business gets isolated data, custom branding, and dedicated access." },
  { icon: Zap,          color: "#22C55E", title: "Works on 3G",          desc: "Engineered for Tanzania's connectivity — lightweight, fast-loading, and functional on mid-range Android phones." },
]
