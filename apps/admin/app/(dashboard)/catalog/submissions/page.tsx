...
export default function SubmissionsPage() {
  const { data, loading, error, refetch } = useAdminFetch(useCallback(() => fetchSubmissions(), []))
  ...
  if (loading) {
    return (
      <div>
        <PageHeader title="Community Submissions" description="Loading…" />
  ...
  if (error) {
    return (
      <div>
        <PageHeader title="Community Submissions" description="Failed to load" />
