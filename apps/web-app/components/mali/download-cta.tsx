        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div>
              ...
              <h2
                id="download-heading"
                className="font-heading text-4xl lg:text-5xl font-medium text-balance"
              >
            ...
            <p className="text-primary-foreground/70 text-lg leading-relaxed max-w-md mx-auto lg:mx-0">
              Download Mali Up and take control of your money, assets, and business. Free to start, powerful to grow.
            </p>
            ...
            >
              <a
                href="#app-store"
                className="inline-flex items-center gap-3 px-6 py-4 bg-primary-foreground text-foreground rounded-2xl transition-all hover:scale-105 hover:shadow-xl group"
              >
