...
const steps = [
  {
    ...
    number: "01",
    title: "Manage",
    subtitle: "Endesha biashara yako — Run your business",
    color: "#C8847B",
  ...
  },
  {
    ...
    number: "02",
    title: "Track",
    subtitle: "Fuatilia pesa yako — Every shilling, accounted for",
    color: "#7CB798",
  ...
  },
  {
    ...
    number: "03",
    title: "Register",
    subtitle: "Hifadhi mali yako — Your assets, secured",
    color: "#D4A574",
  ...
  },
  {
    ...
    number: "04",
    title: "Grow",
    subtitle: "Ona picha kamili — See the full picture",
    color: "#8B7355",
