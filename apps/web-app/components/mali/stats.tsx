...
const stats = [
  { value: 2400, suffix: "+", label: "Early Users Joined",      sublabel: "Assets, money & business", color: "#F5A623", icon: TrendingUp },
  { value: 24,   suffix: "",  label: "Powerful Modules",        sublabel: "Across 3 pillars",         color: "#22C55E", icon: Layers },
      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10">
        <div className="text-center mb-16 flex flex-col gap-4">
          ...
          <p className="reveal text-[#0C1B2E]/65 max-w-md mx-auto leading-relaxed">
            From Dar es Salaam to Lagos — individuals, asset owners, and businesses across Africa are choosing Mali Up to see their complete wealth picture in one place.
          </p>
        </div>
